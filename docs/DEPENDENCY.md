...
This document describes the local tools needed to develop, document, and test the `nuc-certificates` Helm chart.
...
- `CERT_MANAGER_VERSION`: `v1.19.2` in `tests/e2e/test-e2e.sh`
